...
for i=1:warp_max_level+1
   ...
   dz = warp_solver_gs_color_robust_data_flow_driven([nx_fine ny_fine],[hx_fine hy_fine],[cur_alpha gamma 0.0000001 sor iteration],gJ11, gJ22, gJ12, GJ11, GJ22, GJ12, z_init);
